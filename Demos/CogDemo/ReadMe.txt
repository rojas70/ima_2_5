Cog Demo - Head Module to be opened in Sally and Arm Module to be opened in HungerForce.

Open the CogDemo - HungerForce.cmp file in DAD.exe in HungerForce, and
Open the CogDemo - Sally.cmp file in DAD.exe in Sally.
