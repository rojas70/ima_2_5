...
#define PROC_FORMAT_STRING_SIZE   447                               
...
/* Object interface: IFTSensorCom, ver. 0.0,
   GUID={0xAE08C1B6,0x9B59,0x4131,{0x8C,0x78,0x71,0x4B,0x03,0x6B,0xEC,0x38}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IFTSensorCom_ServerInfo;
...
static const unsigned short IFTSensorCom_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IFTSensorCom_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IFTSensorCom_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IFTSensorCom_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IFTSensorCom_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(24) _IFTSensorComProxyVtbl = 
{
    &IFTSensorCom_ProxyInfo,
    &IID_IFTSensorCom,
    ...
    (void *)-1 /* IFTSensorCom::SampleFTData */ ,
    (void *)-1 /* IFTSensorCom::get_CurrentFrame */ ,
    (void *)-1 /* IFTSensorCom::put_CurrentFrame */ ,
    (void *)-1 /* IFTSensorCom::get_CurrentFrameIndex */ ,
    (void *)-1 /* IFTSensorCom::put_CurrentFrameIndex */ ,
    (void *)-1 /* IFTSensorCom::get_AverageLength */ ,
    (void *)-1 /* IFTSensorCom::put_AverageLength */ ,
    (void *)-1 /* IFTSensorCom::get_DeviceFilename */ ,
    (void *)-1 /* IFTSensorCom::put_DeviceFilename */ ,
    (void *)-1 /* IFTSensorCom::get_FTWristSide */ ,
    (void *)-1 /* IFTSensorCom::put_FTWristSide */ ,
    (void *)-1 /* IFTSensorCom::Initialize */ ,
    (void *)-1 /* IFTSensorCom::get_ErrorMessage */ ,
    (void *)-1 /* IFTSensorCom::put_ErrorMessage */ ,
    (void *)-1 /* IFTSensorCom::BiasSensor */ ,
    (void *)-1 /* IFTSensorCom::EnablePeaks */ ,
    (void *)-1 /* IFTSensorCom::Close */
};


static const PRPC_STUB_FUNCTION IFTSensorCom_table[] =
{
...
CInterfaceStubVtbl _IFTSensorComStubVtbl =
{
    &IID_IFTSensorCom,
    &IFTSensorCom_ServerInfo,
    24,
    &IFTSensorCom_table[-3],
...
/* 76 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_CurrentFrameIndex */
...
/* 104 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_CurrentFrameIndex */
...
/* 208 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 210 */	NdrFcShort( 0x2a ),	/* Type Offset=42 */
...
/* 264 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 266 */	NdrFcShort( 0x2a ),	/* Type Offset=42 */
...
/* 292 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 294 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 338 */	0x5,		/* Oi2 Flags:  srv must size, has return, */
			0x2,		/* 2 */
...
/* 342 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 344 */	NdrFcShort( 0x2a ),	/* Type Offset=42 */
...
/* 366 */	0x6,		/* Oi2 Flags:  clt must size, has return, */
			0x2,		/* 2 */
...
const CInterfaceProxyVtbl * _IMA2_FTSensorLib_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFTSensorComProxyVtbl,
    0
};

const CInterfaceStubVtbl * _IMA2_FTSensorLib_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFTSensorComStubVtbl,
    0
};

PCInterfaceName const _IMA2_FTSensorLib_InterfaceNamesList[] = 
{
    "IFTSensorCom",
    0
};

const IID *  _IMA2_FTSensorLib_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _IMA2_FTSensorLib_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _IMA2_FTSensorLib, pIID, n)

int __stdcall _IMA2_FTSensorLib_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_IMA2_FTSensorLib_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo IMA2_FTSensorLib_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _IMA2_FTSensorLib_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _IMA2_FTSensorLib_StubVtblList,
    (const PCInterfaceName * ) & _IMA2_FTSensorLib_InterfaceNamesList,
    (const IID ** ) & _IMA2_FTSensorLib_BaseIIDList,
    & _IMA2_FTSensorLib_IID_Lookup, 
    1,
    2,
