...
#define PROC_FORMAT_STRING_SIZE   885                               
...
/* Object interface: IPressureForceCharacterization, ver. 0.0,
   GUID={0x94F541B1,0x0CC5,0x4F4B,{0x8B,0x07,0x43,0x97,0xED,0x7F,0x3D,0xC5}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IPressureForceCharacterization_ServerInfo;
...
CLIENT_CALL_RETURN _RetVal;
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Object_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[772],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
CLIENT_CALL_RETURN _RetVal;
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[816],
                  ( unsigned char __RPC_FAR * )&This,
                  ( unsigned char __RPC_FAR * )&whatjoint,
                  ( unsigned char __RPC_FAR * )&basepressure,
                  ( unsigned char __RPC_FAR * )&pressurechange,
                  ( unsigned char __RPC_FAR * )&numberofsteps);
#else
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Object_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[816],
...
static const unsigned short IPressureForceCharacterization_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IPressureForceCharacterization_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IPressureForceCharacterization_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IPressureForceCharacterization_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IPressureForceCharacterization_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(39) _IPressureForceCharacterizationProxyVtbl = 
{
    &IPressureForceCharacterization_ProxyInfo,
    &IID_IPressureForceCharacterization,
    ...
    (void *)-1 /* IPressureForceCharacterization::get_OutputMinIndex */ ,
    (void *)-1 /* IPressureForceCharacterization::put_OutputMinIndex */ ,
    (void *)-1 /* IPressureForceCharacterization::get_OutputMaxIndex */ ,
    (void *)-1 /* IPressureForceCharacterization::put_OutputMaxIndex */ ,
    (void *)-1 /* IPressureForceCharacterization::get_OutputMin */ ,
    (void *)-1 /* IPressureForceCharacterization::put_OutputMin */ ,
    (void *)-1 /* IPressureForceCharacterization::get_OutputMax */ ,
    (void *)-1 /* IPressureForceCharacterization::put_OutputMax */ ,
    (void *)-1 /* IPressureForceCharacterization::get_HomingSteps */ ,
    (void *)-1 /* IPressureForceCharacterization::put_HomingSteps */ ,
    (void *)-1 /* IPressureForceCharacterization::get_LeftArm */ ,
    (void *)-1 /* IPressureForceCharacterization::put_LeftArm */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair1 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair1 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair2 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair2 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair3 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair3 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair4 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair4 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair5 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair5 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_PressureForRubbertuatorPair6 */ ,
    (void *)-1 /* IPressureForceCharacterization::put_PressureForRubbertuatorPair6 */ ,
    (void *)-1 /* IPressureForceCharacterization::get_FileName */ ,
    IPressureForceCharacterization_put_FileName_Proxy ,
    IPressureForceCharacterization_Initialize_Proxy ,
    IPressureForceCharacterization_StartCharacerizationProcess_Proxy ,
    IPressureForceCharacterization_VerticalPush1_Proxy ,
    IPressureForceCharacterization_WriteDataToFile_Proxy ,
    IPressureForceCharacterization_ChangePressure_Proxy ,
    IPressureForceCharacterization_GoToHomePosition_Proxy
};


static const PRPC_STUB_FUNCTION IPressureForceCharacterization_table[] =
{
...
CInterfaceStubVtbl _IPressureForceCharacterizationStubVtbl =
{
    &IID_IPressureForceCharacterization,
    &IPressureForceCharacterization_ServerInfo,
    39,
    &IPressureForceCharacterization_table[-3],
...
/* 334 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair1 */
...
/* 362 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair1 */
...
/* 390 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair2 */
...
/* 418 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair2 */
...
/* 446 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair3 */
...
/* 474 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair3 */
...
/* 502 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair4 */
...
/* 530 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair4 */
...
/* 558 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair5 */
...
/* 586 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair5 */
...
/* 614 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_PressureForRubbertuatorPair6 */
...
/* 642 */	0x8,		/* FC_LONG */
	...
	/* Procedure put_PressureForRubbertuatorPair6 */
...
/* 690 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 692 */	NdrFcShort( 0x2a ),	/* Type Offset=42 */
...
/* 748 */	0x8,		/* FC_LONG */
	...
	/* Procedure StartCharacerizationProcess */
...
/* 770 */	0x8,		/* FC_LONG */
	...
	/* Procedure VerticalPush1 */

/* 772 */	0x33,		/* FC_AUTO_HANDLE */
			0x6c,		/* Old Flags:  object, Oi2 */
/* 774 */	NdrFcLong( 0x0 ),	/* 0 */
/* 778 */	NdrFcShort( 0x23 ),	/* 35 */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 824 */	NdrFcShort( 0x20 ),	/* x86, MIPS, PPC Stack size/offset = 32 */
#else
			NdrFcShort( 0x30 ),	/* Alpha Stack size/offset = 48 */
#endif
/* 826 */	NdrFcShort( 0x2c ),	/* 44 */
...
#ifndef _ALPHA_
/* 852 */	NdrFcShort( 0x18 ),	/* x86, MIPS, PPC Stack size/offset = 24 */
#else
...
#ifndef _ALPHA_
/* 858 */	NdrFcShort( 0x1c ),	/* x86, MIPS, PPC Stack size/offset = 28 */
#else
...
const CInterfaceProxyVtbl * _PressureAndForctTorqueCharacterization_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPressureForceCharacterizationProxyVtbl,
    0
};

const CInterfaceStubVtbl * _PressureAndForctTorqueCharacterization_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPressureForceCharacterizationStubVtbl,
    0
};

PCInterfaceName const _PressureAndForctTorqueCharacterization_InterfaceNamesList[] = 
{
    "IPressureForceCharacterization",
    0
};

const IID *  _PressureAndForctTorqueCharacterization_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PressureAndForctTorqueCharacterization_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PressureAndForctTorqueCharacterization, pIID, n)

int __stdcall _PressureAndForctTorqueCharacterization_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PressureAndForctTorqueCharacterization_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PressureAndForctTorqueCharacterization_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PressureAndForctTorqueCharacterization_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PressureAndForctTorqueCharacterization_StubVtblList,
    (const PCInterfaceName * ) & _PressureAndForctTorqueCharacterization_InterfaceNamesList,
    (const IID ** ) & _PressureAndForctTorqueCharacterization_BaseIIDList,
    & _PressureAndForctTorqueCharacterization_IID_Lookup, 
    1,
    2,
