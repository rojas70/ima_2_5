...
CNNMuscles891011Angle4::CNNMuscles891011Angle4(int m, int leftright)
{
	forwardvalue = m;	
	leftorrightarm = leftright;
}

CNNMuscles891011Angle4::~CNNMuscles891011Angle4()
{
	fclose(TrainData);
	fclose(weights)   ;
	fclose(hata)     ;
...
void CNNMuscles891011Angle4::Allocator(void)
{
	using namespace std;
...
void CNNMuscles891011Angle4::IsExist(void)
{
		if (leftorrightarm) //Left Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle891011Angle4FWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle891011Angle4FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataForward891011Angle4.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataForward891011Angle4.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle891011Angle4FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle891011Angle4FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle891011Angle4BWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle891011Angle4BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataBackward891011Angle4.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataBackward891011Angle4.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle891011Angle4BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle891011Angle4BWeightsErrors.txt\n");
			}
		}
		...
		if (!leftorrightarm) //Right Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle891011Angle4FWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle891011Angle4FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataForward891011Angle4.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataForward891011Angle4.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle891011Angle4FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle891011Angle4FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle891011Angle4BWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle891011Angle2BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataBackward891011Angle4.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataBackward891011Angle4.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle891011Angle4BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle891011Angle4BWeightsErrors.txt\n");
			}
		}
}

void CNNMuscles891011Angle4::Input(void)
{
	for (t=0;t<(m);t++)
		for (i=0;i<nInput;i++)
			inputx[t][i]  =0;		
	...
	// Here Normalizing the Angles.changes between  55 & 135 to 0-1 
	for(t=0;t<m;t++)
		inputx[t][0] = (inputx[t][0] + 40 ) / 80;

}

void CNNMuscles891011Angle4::Process(void)
{
...
void CNNMuscles891011Angle4::WeightsWrite(void)
{
	fprintf(weights,"%d\n",nNeuron);
	fprintf(weights,"%f\n",alfa);
	fprintf(weights,"%f\n",mm);
