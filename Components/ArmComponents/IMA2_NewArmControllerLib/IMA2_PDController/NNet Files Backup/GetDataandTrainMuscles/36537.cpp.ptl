...
CNNMuscles4567Angle3::CNNMuscles4567Angle3(int m, int leftright)
{
	forwardvalue = m;
	leftorrightarm = leftright;
}

CNNMuscles4567Angle3::~CNNMuscles4567Angle3()
{
	fclose(TrainData);
	fclose(weights)   ;
	fclose(hata)     ;
...
void CNNMuscles4567Angle3::Allocator(void)
{
	using namespace std;
...
void CNNMuscles4567Angle3::IsExist(void)
{
		if (leftorrightarm) //Left Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle4567Angle3FWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle3FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataForward4567Angle3.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataForward4567Angle3.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle4567Angle3FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle3FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle4567Angle3BWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle3BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataBackward4567Angle3.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataBackward4567Angle3.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle4567Angle3BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle3BWeightsErrors.txt\n");
			}
		}
		...
		if (!leftorrightarm) //Right Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle4567Angle3FWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle3FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataForward4567Angle3.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataForward4567Angle3.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle4567Angle3FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle3FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle4567Angle3BWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle3BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataBackward4567Angle3.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataBackward4567Angle3.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle4567Angle3BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle3BWeightsErrors.txt\n");
			}
		}
}

void CNNMuscles4567Angle3::Input(void)
{
	for (t=0;t<(m);t++)
		for (i=0;i<nInput;i++)
			inputx[t][i]  =0;		
	...
	// Here Normalizing the Angles.changes between  -40 & 30 to 0-1 
	for(t=0;t<m;t++)
		inputx[t][0] = (inputx[t][0] + 40 ) / 70;

}

void CNNMuscles4567Angle3::Process(void)
{
...
void CNNMuscles4567Angle3::WeightsWrite(void)
{
	fprintf(weights,"%d\n",nNeuron);
	fprintf(weights,"%f\n",alfa);
	fprintf(weights,"%f\n",mm);
