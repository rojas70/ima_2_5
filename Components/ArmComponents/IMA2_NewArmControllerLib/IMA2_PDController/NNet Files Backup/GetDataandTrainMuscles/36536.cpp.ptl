...
CNNMuscles4567Angle2::CNNMuscles4567Angle2(int m, int leftright)
{
	forwardvalue = m;
	leftorrightarm = leftright;
}

CNNMuscles4567Angle2::~CNNMuscles4567Angle2()
{
	fclose(TrainData);
	fclose(weights)   ;
	fclose(hata)     ;
...
void CNNMuscles4567Angle2::Allocator(void)
{
	using namespace std;
...
void CNNMuscles4567Angle2::IsExist(void)
{
		if (leftorrightarm) //Left Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle4567Angle2FWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle2FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataForward4567Angle2.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataForward4567Angle2.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle4567Angle2FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle2FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\LeftNNmuscle4567Angle2BWeights.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle2BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\LeftNeuralDataBackward4567Angle2.txt", "r" )) == NULL )
					printf( "Can't Open File LeftNeuralDataBackward4567Angle2.txt\n" );

				if ((hata=fopen("..\\NNWeights\\LeftNNmuscle4567Angle2BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File LeftNNmuscle4567Angle2BWeightsErrors.txt\n");
			}
		}
		...
		if (!leftorrightarm) //Right Arm
		{
			if ( forwardvalue ==1 )
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle4567Angle2FWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle2FWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataForward4567Angle2.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataForward4567Angle2.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle4567Angle2FWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle2FWeightsErrors.txt\n");

			}else 
			{
				if ((weights=fopen("..\\NNWeights\\RightNNmuscle4567Angle2BWeights.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle2BWeights.txt\n");
					
				if( (TrainData=fopen( "..\\TrainFiles\\RightNeuralDataBackward4567Angle2.txt", "r" )) == NULL )
					printf( "Can't Open File RightNeuralDataBackward4567Angle2.txt\n" );

				if ((hata=fopen("..\\NNWeights\\RightNNmuscle4567Angle2BWeightsErrors.txt","w"))==NULL)		
					printf("Can't Open File RightNNmuscle4567Angle2BWeightsErrors.txt\n");
			}
		}
}

void CNNMuscles4567Angle2::Input(void)
{
	for (t=0;t<(m);t++)
		for (i=0;i<nInput;i++)
			inputx[t][i]  =0;		
	...
	// Here Normalizing the Angles.changes between - 145- 210 to 0-1 
	for(t=0;t<m;t++)
		inputx[t][0] = (inputx[t][0] + 215 ) / 75;

}

void CNNMuscles4567Angle2::Process(void)
{
...
void CNNMuscles4567Angle2::WeightsWrite(void)
{
	fprintf(weights,"%d\n",nNeuron);
	fprintf(weights,"%f\n",alfa);
	fprintf(weights,"%f\n",mm);
