...
//
//////////////////////////////////////////////////////////////////////
#ifndef _Train891011Angle5_h
#define _Train891011Angle5_h
...
class CNNMuscles891011Angle5
{
public:
	CNNMuscles891011Angle5(int m, int leftright);
	virtual ~CNNMuscles891011Angle5();
	void Allocator(void); // 
	void Input(void); // 
