% plot HP3 axes in home configuration 
% DH parameters are those published
% the polarities of joints 3-6 are reversed w.r.t. the TP.
% 15 July 2008
...
% plot the links
line([  0   0],[0 0], [  0 110],'Color',[1,0.7,0],'LineWidth',1); % 1 to 2
line([  0 100],[0 0], [110 110],'Color','y','LineWidth',1); % 1 to 2
line([100 100],[0 0], [110 400],'Color','y','LineWidth',1); % 2 to 3
line([100 100],[0 0], [400 485],'Color','y','LineWidth',1); % 3 to 4
line([100 400],[0 0], [485 485],'Color',[1,0.7,0],'LineWidth',1); % 3 to 4
line([400 490],[0 0], [485 485],'Color',[1,0.7,0],'LineWidth',1); % 3 to 4
...
% Pose4 = eye(4);
% Pose4(1:3,1:3) = RotX(pi)*RotY(-pi/2);
