...
% kinematics presentation. 
    ...
    elseif(strcmp(method,'AD')) % Algebraic derivation is called
        ...
        % ***** Joint Angle 6*****
        q6 = atan2( r11*(cos(q1)*cos(q2+q3)*sin(q4) + sin(q1)*cos(q4)) - r21*(sin(q1)*cos(q2+q3)*sin(q4) + cos(q1)*cos(q4)) + r31*(sin(q2+q3)*sin(q4)), r11*((-cos(q1)*cos(q2+q3)*cos(q4) + sin(q1)*sin(q4))*cos(q5) - cos(q1)*sin(q2+q3)*sin(q5)) + r21*((sin(q1)*cos(q2+q3)*cos(q4) - cos(q1)*sin(q4))*cos(q5) - sin(q1)*sin(q2+q3)*sin(q5)) - r31*(sin(q2+q3)*cos(q4)*cos(q5) + cos(q2+q3)*sin(q5)));
        % Print out vector of joint angles.
        Q = [q1; q2; q3;q4;q5;q6] * 180/pi;
