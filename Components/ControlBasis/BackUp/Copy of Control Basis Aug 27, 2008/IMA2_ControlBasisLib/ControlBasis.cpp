...
void CControlBasis::SetGains()
{
	...
	if(m_sWhatRobot == HP3JC_ROBOT)
	{				
		m_dPositionGain[0] =  0.000425;		m_dForceGain[0] = 0.005; 	m_dMomentGain[0] = 0; 	
		m_dPositionGain[1] = -0.0002;		m_dForceGain[1] = -0.005; 	m_dMomentGain[1] = 0; 	
		m_dPositionGain[2] = -0.0002;		m_dForceGain[2] = -0.005; 	m_dMomentGain[2] = 0; 	
		m_dPositionGain[3] = 0.00056;		m_dForceGain[3] = 0;		m_dMomentGain[3] =   0.200; 	
		m_dPositionGain[4] = 0.00056;		m_dForceGain[4] = 0;		m_dMomentGain[4] =  -0.200; 	
		m_dPositionGain[5] = 0.00056;		m_dForceGain[5] = 0;		m_dMomentGain[5] =   0.200; 	
	}

	// If the force and moment controllers are running, then:
	// Seems like the moment output is ~7 larger than the force controller
	if(m_sNumControllers == 2)
	{
		m_dMomentGain[3] =   0.005;
		m_dMomentGain[4] =  -0.005;
		m_dMomentGain[5] =   0.005;
	}
...
HRESULT CControlBasis::ComputeJacobian(short TypeOfController)
{
	...
	if(m_sWhatRobot == HP3JC_ROBOT)
	{
		...
		if(TypeOfController == DOMINANT_POSITION_CONTROLLER || TypeOfController == SUBORDINATE_POSITION_CONTROLLER)
		{
			// 1st row of transform jacobian
			J11 = (-520*cos(Angle[1])*sin(Angle[0]) - 3*(180 + 163*cos(Angle[4]))*sin(Angle[0])*sin(Angle[1] - Angle[2]) + 489*cos(Angle[0])*sin(Angle[3])*sin(Angle[4]) + 3*cos(Angle[1] - Angle[2])*sin(Angle[0])*(-20 + 163*cos(Angle[3])*sin(Angle[4])))/2;
			J12 = (489*sin(Angle[0])*sin(Angle[3])*sin(Angle[4]) + cos(Angle[0])*(520*cos(Angle[1]) + 3*(180 + 163*cos(Angle[4]))*sin(Angle[1] - Angle[2]) + cos(Angle[1] - Angle[2])*(60 - 489*cos(Angle[3])*sin(Angle[4]))))/2;
			J13 = 0;
			J14 = 0;
			J15 = 0;
			J16 = 1;
			...
			J21 = (cos(Angle[0])*(3*cos(Angle[1])*(cos(Angle[2])*(180 + 163*cos(Angle[4])) + sin(Angle[2])*(20 - 163*cos(Angle[3])*sin(Angle[4]))) + sin(Angle[1])*(-520 + (540 + 489*cos(Angle[4]))*sin(Angle[2]) + cos(Angle[2])*(-60 + 489*cos(Angle[3])*sin(Angle[4])))))/2;
			J22 = (sin(Angle[0])*(3*cos(Angle[1])*(cos(Angle[2])*(180 + 163*cos(Angle[4])) + sin(Angle[2])*(20 - 163*cos(Angle[3])*sin(Angle[4]))) + sin(Angle[1])*(-520 + (540 + 489*cos(Angle[4]))*sin(Angle[2]) + cos(Angle[2])*(-60 + 489*cos(Angle[3])*sin(Angle[4])))))/2;
			J23 = (-3*sin(Angle[1])*(cos(Angle[2])*(180 + 163*cos(Angle[4])) + sin(Angle[2])*(20 - 163*cos(Angle[3])*sin(Angle[4]))) + cos(Angle[1])*(-520 + (540 + 489*cos(Angle[4]))*sin(Angle[2]) + cos(Angle[2])*(-60 + 489*cos(Angle[3])*sin(Angle[4]))))/2;
			J24 = -sin(Angle[0]);
			J25 = cos(Angle[0]);
			J26 = 0;
			...
			J33 = (3*(180 + 163*cos(Angle[4]))*sin(Angle[1] - Angle[2]))/2 + cos(Angle[1] - Angle[2])*(30 - (489*cos(Angle[3])*sin(Angle[4]))/2);
			J34 = sin(Angle[0]);
			J35 = -cos(Angle[0]);
			J36 = 0;
			...
			J45 = sin(Angle[0])*sin(Angle[1] - Angle[2]);
			...
			J53 = (489*(cos(Angle[3])*cos(Angle[4])*sin(Angle[1] - Angle[2]) - cos(Angle[1] - Angle[2])*sin(Angle[4])))/2;
			J54 = cos(Angle[3])*sin(Angle[0]) + cos(Angle[0])*cos(Angle[1] - Angle[2])*sin(Angle[3]);
			J55 = -(cos(Angle[0])*cos(Angle[3])) + cos(Angle[1] - Angle[2])*sin(Angle[0])*sin(Angle[3]);
			...
			J65 = cos(Angle[4])*sin(Angle[0])*sin(Angle[1] - Angle[2]) - (cos(Angle[1] - Angle[2])*cos(Angle[3])*sin(Angle[0]) + cos(Angle[0])*sin(Angle[3]))*sin(Angle[4]);
		...
		if(TypeOfController == DOMINANT_FORCE_CONTROLLER || TypeOfController == SUBORDINATE_FORCE_CONTROLLER) 
		{
			...
			// 4th row of transform matrix, J'
			// I have cancelled these terms to prevent rotation in the for-arm when the robot is moving sideways.
			J41 = (489*(cos(Angle[3])*sin(Angle[0]) + cos(Angle[0])*cos(Angle[1] - Angle[2])*sin(Angle[3]))*sin(Angle[4]))/2;
			J42 = (-489*(cos(Angle[0])*cos(Angle[3]) - cos(Angle[1] - Angle[2])*sin(Angle[0])*sin(Angle[3]))*sin(Angle[4]))/2;
			J43 = (-489*sin(Angle[1] - Angle[2])*sin(Angle[3])*sin(Angle[4]))/2;
		...
		if(TypeOfController == DOMINANT_MOMENT_CONTROLLER || TypeOfController == SUBORDINATE_MOMENT_CONTROLLER) 
		{
			...
			// 2nd row of transform matrix, J'
			// Cancelled these terms so only the wrist moves, particularly in up/down motions.
			J24 = 0; //-sin(Angle[0]);
			J25 = 0; // cos(Angle[0]);
			J26 = 0;
...
* 4) Print error results to file.
* 5) Call JacobianProduct to compute the product from the 
...
void CControlBasis::ComputeControllerOutput(bool SubordinateController)
{
	...
	if(SubordinateController == DOMINANT) // We have a dominant controller
	{
		...
		if(m_sWhichIsDomController == DOMINANT_POSITION_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("DomPosError", m_dDomCont_Error, "DomPosError.txt");

			// 5) Calculate product between Jacobian transform and TempBuffer. Store result in OUTPUT vector.
		...
		else if(m_sWhichIsDomController == DOMINANT_FORCE_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("DomForceError", m_dDomCont_Error, "DomForceError.txt");
		...
		else if(m_sWhichIsDomController == DOMINANT_MOMENT_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("DomMomentError", m_dDomCont_Error, "DomMomentError.txt");
	...
	if(SubordinateController == SUBORDINATE) 
	{
		...
		if(m_sWhichIsSubController == SUBORDINATE_POSITION_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("SubPosError", m_dSubCont_Error, "SubPosError.txt");
		...
		else if(m_sWhichIsSubController == SUBORDINATE_FORCE_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("SubForceError", m_dSubCont_Error, "SubForceError.txt");
		...
		else if(m_sWhichIsSubController == SUBORDINATE_MOMENT_CONTROLLER)
		{
			...
			// 4) Print error results (title, data, path)
			Write2File("SubMomentError", m_dSubCont_Error, "SubMomentError.txt");
...
void CControlBasis::JacobianProduct(short TypeOfController, double * TempBuffer)
{
	...
	if(TypeOfController == DOMINANT_POSITION_CONTROLLER || TypeOfController == DOMINANT_FORCE_CONTROLLER || TypeOfController == DOMINANT_MOMENT_CONTROLLER)
	{
		...
		if(m_sWhatRobot == HP3JC_ROBOT)
		{
			// Write results for Position Controller
			if(m_sWhichIsDomController == DOMINANT_POSITION_CONTROLLER)
				Write2File("DomPosCont", m_dDomCont_Output, "HP3JC_DomPosCont.txt");
			if(m_sWhichIsDomController == DOMINANT_FORCE_CONTROLLER) 
				Write2File("DomForceCont", m_dDomCont_Output, "HP3JC_DomForceCont.txt");
			if(m_sWhichIsDomController == DOMINANT_MOMENT_CONTROLLER) 
				Write2File("DomMomentCont", m_dDomCont_Output, "HP3JC_DomMomentCont.txt");
		}
		...
		else	// ISAC robot
		{
			// Write results for Position Controller
			if(m_sWhichIsDomController == DOMINANT_POSITION_CONTROLLER)
				Write2File("DomPosCont_JointAngles", m_dDomCont_Output, "ISAC_DomPosCont.txt");
			if(m_sWhichIsDomController == DOMINANT_FORCE_CONTROLLER) 
				Write2File("DomForceCont_JointAngles", m_dDomCont_Output, "ISAC_DomForceCont.txt");
			if(m_sWhichIsDomController == DOMINANT_MOMENT_CONTROLLER) 
				Write2File("DomMomentCont_JointAngles", m_dDomCont_Output, "ISAC_DomMomentCont.txt");
		}
		...
		//Write2File("Updated Joint Angles", m_dDomCont_Output, "UpdateJointAngles.txt");	// Write updated joint angles to file
	...
	if(TypeOfController == SUBORDINATE_POSITION_CONTROLLER || TypeOfController == SUBORDINATE_FORCE_CONTROLLER || TypeOfController == SUBORDINATE_MOMENT_CONTROLLER)
	{
		...
		// 3) Write to file
		// By robot and controller
		if(m_sWhatRobot == HP3JC_ROBOT)
		{

			if(m_sWhichIsDomController == SUBORDINATE_POSITION_CONTROLLER)
				Write2File("SubPosController", m_dSubCont_Output, "HP3JC_SubPosCont.txt");
			if(m_sWhichIsDomController == SUBORDINATE_FORCE_CONTROLLER) 
				Write2File("SubForceCont", m_dSubCont_Output, "HP3JC_SubForceCont.txt");
			if(m_sWhichIsDomController == SUBORDINATE_MOMENT_CONTROLLER) 
				Write2File("SubMomentCont", m_dSubCont_Output, "HP3JC_SubMomentCont.txt");
		}
		...
		else	// ISAC robot
		{
			// Write results for Position Controller
			if(m_sWhichIsDomController == SUBORDINATE_POSITION_CONTROLLER)
				Write2File("SubPosController", m_dSubCont_Output, "ISAC_SubPosCont.txt");
			if(m_sWhichIsDomController == SUBORDINATE_FORCE_CONTROLLER) 
				Write2File("SubForceCont", m_dSubCont_Output, "ISAC_SubForceCont.txt");
			if(m_sWhichIsDomController == SUBORDINATE_MOMENT_CONTROLLER) 
				Write2File("SubMomentCont", m_dSubCont_Output, "ISAC_SubMomentCont.txt");
		}



		// 4) Add the update in joint Angle to the actual joint angle position.
		//for(i = 0; i<NUM_AXES; i++)
...
HRESULT CControlBasis::GetDominantVectorData()
{
	...
	// Clear noise 
	for(i=0; i<NUM_AXES;i++)
		if(m_dDomCont_ActualInput[i] != 0.0 && fabs(m_dDomCont_ActualInput[i]) < 0.3)
			m_dDomCont_ActualInput[i] = 0.0;
...
void CControlBasis::Write2File(char * title, double * data , char * textfile)
{
	int i;
	USES_CONVERSION;
...
void CControlBasis::WriteJointAngleHomePosition()
{
	...
	// Do likewise for m_dPreviousControllerOutput, so that the first time the output data is averaged,
	// it is wrt to the home position and not zero. This would generate an abrupt jump in the first cycle
	// of updated joint angles data.
	
	m_dPreviousControllerOutput[0] =    0.0;
	m_dPreviousControllerOutput[1] = - 90.0;
	m_dPreviousControllerOutput[2] =    0.0;
	m_dPreviousControllerOutput[3] =  180.0;
	m_dPreviousControllerOutput[4] = - 90.0;
	m_dPreviousControllerOutput[5] =    0.0;
