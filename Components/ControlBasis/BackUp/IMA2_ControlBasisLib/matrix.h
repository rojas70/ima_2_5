/*
 * @(#)matrix.h    generated by: makeheader 5.1.3  Thu Jan 11 14:54:42 2007
 *
 ...
 */
EXTERN_C mxArray *mxCreateStructMatrix(mwSize m, mwSize n, int nfields, const char **fieldnames);
