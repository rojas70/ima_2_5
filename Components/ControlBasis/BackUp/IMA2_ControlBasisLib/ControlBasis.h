...
// Force Controller Reference Values
#define Des_Fx 10.0
#define Des_Fy  0.0
#define Des_Fz  0.05
/////////////////////////////////////////////////////////////////////////////
...
public:
	...
	STDMETHOD(get_ref_DesFT_ReferenceValue)(/*[out, retval]*/ short *pVal);
	STDMETHOD(put_ref_DesFT_ReferenceValue)(/*[in]*/ short newVal);

	STDMETHOD(get_CumulativeError)(/*[out, retval]*/ double *pVal);
	STDMETHOD(put_CumulativeError)(/*[in]*/ double newVal);
