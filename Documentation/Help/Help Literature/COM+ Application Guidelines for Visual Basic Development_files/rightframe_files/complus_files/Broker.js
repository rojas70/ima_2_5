...
function SiteRecruit_PageConfigurationBroker()
{
    ...
    function PageConfigurationBroker_initializeMapping()
    {
        ...
        var x = this.priorities;
                ...
                p[0] = '/library/svy/SiteRecruit_PageConfiguration_2641mt_All_2681mt-MSDN.js';
                x[0] = 0;
                                        
             
                            // http://msdn.microsoft.com/vbasic
                u[1] = '//[\\w\\.-]+/vbasic((/)|(/default\\.asp)|(/default\\.mspx)|(/default\\.aspx))?$';
                p[1] = '/library/svy/SiteRecruit_PageConfiguration_2475mt.js';
                x[1] = 1;
