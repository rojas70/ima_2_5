...
Begin VB.UserControl InsertComponentView 
   ...
   Begin VB.CommandButton cmd 
      Height          =   315
      Left            =   5640
      Picture         =   "InsertComponentView.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Width           =   345
...
'****************************************************************************************************************************************
    ...
    Private Sub UserControl_Resize()
        lvw.Height = UserControl.ScaleHeight - lvw.Top - 3 '- pbr.Height
    ...
    Private Sub ShowItems(ItemIcon As IMA2_Icons)
        ...
        If Not (m_CurLib Is Nothing) Then Call cmb.ComboItems.Add(, , m_CurLib.Name, II_Library, , 1)
