...
Begin VB.UserControl InsertComponentView 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   415
   ToolboxBitmap   =   "InsertComponentView.ctx":0000
   ...
   Begin VB.CommandButton cmd 
      DisabledPicture =   "InsertComponentView.ctx":0312
      DownPicture     =   "InsertComponentView.ctx":0654
      Enabled         =   0   'False
      Height          =   315
      Left            =   5640
      Picture         =   "InsertComponentView.ctx":0996
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Width           =   345
...
'****************************************************************************************************************************************
    ...
    Private Sub UserControl_InitProperties()
        m_Libs.Path = "C:\Ima2\Components"
        Call ShowItems(II_Network)
    End Sub
    
    Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
        m_Libs.Path = PropBag.ReadProperty("Path", "C:\Ima2\Components")
        Call ShowItems(II_Network)
    End Sub
    
    Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
        Call PropBag.WriteProperty("Path", m_Libs.Path, "C:\Ima2\Components")
    End Sub
    ...
    Private Sub ShowItems(ItemIcon As IMA2_Icons)
        ...
        Call cmb.ComboItems.Add(, , "IMA2 Components on \\IMA2SERVER", II_Network, , 0)
