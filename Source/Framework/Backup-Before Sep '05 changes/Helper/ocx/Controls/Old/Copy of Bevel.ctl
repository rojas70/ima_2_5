...
'******************************************************************************************************************************
    ...
    Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
        m_Side = PropBag.ReadProperty("Sides", 2)
        m_Weight = PropBag.ReadProperty("Weight", 1)
        m_Saved = True
        UserControl_Resize
    End Sub
    
    Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
        Call PropBag.WriteProperty("Sides", m_Side, 2)
        Call PropBag.WriteProperty("Weight", m_Weight, 1)
    End Sub
    ...
    Private Sub UserControl_Resize()
        ...
        If (UserControl.Width > UserControl.Height) And Not m_Saved Then
            m_Side = bsTop
            m_Saved = True
        End If
