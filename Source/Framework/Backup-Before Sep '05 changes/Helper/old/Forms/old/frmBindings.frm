...
Begin VB.Form frmBindings 
   ...
   Begin MSComctlLib.ListView lvw 
      ...
      EndProperty
   End
   Begin IMA2_DAD.OKCancelBar ocb 
...
'**********************************************************************************************************************************
    ...
    Public Sub ShowDialog(Binding As BindingInfo)
    ...
    Public Property Get Binding() As BindingInfo
        Binding = m_Binding
    End Property
...
'**********************************************************************************************************************************
    ...
    Private Sub atv_DblClick(ByVal Node As MSComctlLib.Node)
        ...
        If m_Multiple Then
            lvw.ListItems.Add , atv.Path, atv.Path, , II_Component
            Node.Expanded = True
        Else
            m_Path = atv.Path
            Me.Hide
