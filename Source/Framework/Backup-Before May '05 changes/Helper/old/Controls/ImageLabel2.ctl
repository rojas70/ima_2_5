VERSION 5.00
Begin VB.UserControl ImageLabel2 
   Alignable       =   -1  'True
   CanGetFocus     =   0   'False
   ClientHeight    =   3600
   ClientLeft      =   0
...
Public Property Let Color1(NV As OLE_COLOR)
    lblCaption.ForeColor = NV
End Property

Public Property Let Color2(NV As OLE_COLOR)
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    Color1 = PropBag.ReadProperty("Color1", &HC0C0C0)
    Color2 = PropBag.ReadProperty("Color2", 0)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    PropBag.WriteProperty "Color1", Color1, &HC0C0C0
    PropBag.WriteProperty "Color2", Color2, 0
