...
*
* Example program: 
*    DIdoubleBufHandshake653x.c
*
* Description: 
*    Inputs digital data continuously into a buffer from a group of two
*     digital ports using handshaking (for DIO-32 series devices)
*
* Example Category: 
*    DI
*
...
*    Timeout_Config, NIDAQErrorHandler, DIG_Grp_Config, DIG_Grp_Mode,
*     DIG_DB_Config, Align_DMA_Buffer, DIG_Block_In, DIG_DB_HalfReady,
...
void main(void)
{
    ...
    if (iStatus == 0) {
        ...
        printf(" Digital double-buffered handshaked input is done!\n");
