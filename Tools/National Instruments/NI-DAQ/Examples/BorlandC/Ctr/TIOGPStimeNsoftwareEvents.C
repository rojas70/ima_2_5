...
void main(void)
{
    ...
    printf(" Time N Software Events started...\n");
    ...
    do {
        ...
        iRetVal = NIDAQErrorHandler(iStatus,
         "GPCTR_Control/NANO_SECONDS", iIgnoreWarning);

        printf(" Software trigger occurred at time %lu seconds %lu nanoseconds\n", ulSeconds, ulNanoSeconds);
    ...
    } while ((ulLoopCount < 100) && (iStatus == 0));
    ...
    printf(" Time N Software Events done!\n");
