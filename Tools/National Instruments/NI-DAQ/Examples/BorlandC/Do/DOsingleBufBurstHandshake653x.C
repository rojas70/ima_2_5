...
*
* Example program: 
*    DOsingleBufBurstHandshake653x.c
*
* Description: 
...
*     Set_DAQ_Device_Info, DIG_Block_Out, DIG_Block_Check, NIDAQYield,
*     DIG_Block_Clear
*
...
void main(void)
{
    ...
    if (iStatus == 0) {
        ...
        /* Setup the device for Internal PClock */

        iStatus = Set_DAQ_Device_Info(iDevice,
        ...
        /* Restore default PCLK direction */

        iStatus = Set_DAQ_Device_Info(iDevice,
         ND_CLOCK_REVERSE_MODE_GR1, ND_OFF);
