...
*
* Example program: 
*    DOdoubleBufHandshake653x.c
*
* Description: 
*    Outputs digital data continuously into a buffer from a group of
*     two digital ports using handshaking (pattern generation, for
...
*    iGroup, iGroupSize, iDir, iAckPol, iDBModeON, iOldDataStop,
*     ulCount, iHalfReady, ulBufferSize, iResource, iIgnoreWarning,
*     ulAlignIndex
*
...
*     DIG_Grp_Config, DIG_Grp_Mode, DIG_DB_Config, Align_DMA_Buffer,
*     DIG_Block_Out, DIG_DB_HalfReady, DIG_DB_Transfer, NIDAQYield,
*     DIG_Block_Clear
*
...
void main(void)
{
    ...
    if (iStatus == 0) {
        ...
        printf(" Apply your handshake signal to the I/O connector.\n");
        ...
        printf(" Digital double-buffered handshaked output is done!\n");
