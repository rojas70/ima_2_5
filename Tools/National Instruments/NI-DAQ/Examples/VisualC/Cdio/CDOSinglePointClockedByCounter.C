...
*
* Example program: 
*    CDOSinglePointClockedByCounter.c
*
* Description: 
*    Writes digital data to the output FIFO one point at a time and
*     outputs them at a rate of 100 Hz.  The 100 Hz clock used here is
*     supplied by general purpose counter 0.
*
* Example Category: 
*    CDIO
*
...
*    ulCount, iDOReqSource, ulGpctrNum, ulGpctrOutput, ulLOWcount,
*     ulHIGHcount
*
...
void main(void)
{
    ...
    /* Correlate the output to the signal coming across the RTSI 0
     line. */
    ...
    printf(" Hit any key once your data has finished outputting.\n");
