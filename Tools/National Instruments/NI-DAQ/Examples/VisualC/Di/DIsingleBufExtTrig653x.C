...
*    iGroup, iGroupSize, iDir, iStartTrigON, ulCount, iResource,
*     ulAlignIndex, ulRemaining
*
...
void main(void)
{
    ...
    printf(" Apply the digital trigger to the\n");

    printf(" 'start trigger' pin to start the operation.\n");
    ...
    if (iStatus == 0) {
        ...
        printf(" Digital pattern generation input with digital start trigger is done!\n");
