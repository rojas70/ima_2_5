...
Begin VB.Form frmTQmanager 
   Caption         =   "Text Queue Manager"
   ClientHeight    =   6330
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10650
   ...
   End
End
Attribute VB_Name = "frmTQmanager"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim m_comp As cTextQueue
Dim para As Variant
...
Private Sub cmdViewTxt_Click()
    If cmdViewTxt.Tag = 0 Then
        frmTQmanager.Height = 9360
        cmdViewTxt.Caption = "&Minimize View"
        cmdViewTxt.Tag = 1
    Else
        frmTQmanager.Height = 6810
...
Private Sub Form_Load()
    Set m_comp = CreateObject("textqueue.ctextqueue", "ninja")
